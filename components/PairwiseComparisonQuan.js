...
var defaultPairwiseQuantifiedCb = function (pairwiseQuantified) { };
var coreLogic = function (contactables, statements, question, maxTime, eachCb, maxResponsesText, allCompletedText, timeoutText, invalidResponseText) {
    if (eachCb === void 0) { eachCb = defaultPairwiseQuantifiedCb; }
...
var process = function (input, output) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.trys.push([4, 7, , 9]);
                return [4 /*yield*/, coreLogic(contactables, statements, question, maxTime, function (pairwiseQuantified) {
