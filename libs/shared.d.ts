...
declare const genericPairwise: <T>(contactables: Contactable[], statements: Statement[], contextMsg: string, maxTime: number, eachCb: (el: T) => void, validate: ValidateFn, convertToPairwiseResult: PairwiseResultFn<T>, maxResponsesText?: string, allCompletedText?: string, timeoutText?: string, invalidResponseText?: string) => Promise<T[]>;
