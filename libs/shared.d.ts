...
declare const formatPairwiseList: (description: string, key: string, pairwiseList: any[], anonymize: boolean) => string;
declare const genericPairwise: <T>(contactables: Contactable[], statements: Statement[], contextMsg: string, maxTime: number, eachCb: (el: T) => void, validate: ValidateFn, convertToPairwiseResult: PairwiseResultFn<T>, maxResponsesText?: string, allCompletedText?: string, timeoutText?: string, invalidResponseText?: string, speechDelay?: number) => Promise<T[]>;
export { DEFAULT_ALL_COMPLETED_TEXT, DEFAULT_INVALID_RESPONSE_TEXT, DEFAULT_MAX_RESPONSES_TEXT, DEFAULT_TIMEOUT_TEXT, rulesText, whichToInit, timer, formatPairwiseList, collectFromContactables, genericPairwise, CollectResults, ValidateFn, FormatPairwiseFn, PairwiseResultFn };
